...
#define WINHELP_CTX_xresources_classes "xresources.settings:config-xresourcesclasses"
#define WINHELP_CTX_xresources_map "xresources.settings:config-xresourcesmap"
